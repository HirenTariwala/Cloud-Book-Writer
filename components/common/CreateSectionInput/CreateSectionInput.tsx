...
const CreateSectionInput = ({ actionType, sectionId, onClearHandler, addSectionHandler }: CreateSectionInputProps) => {
    ...
    return (
        <div className="flex gap-4">
            ...
            <button type="button" onClick={() => {
                ...
                className="p-2 bg-[#4179B8]" disabled={!sectionName}>Add</button>
        </div>
    )
}
